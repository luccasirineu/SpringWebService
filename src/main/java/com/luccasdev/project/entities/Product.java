...
public class Product implements Serializable{
	...
	@JsonIgnore //está aqui pois ao pesquisar os produtos eu não quero que apareca os pedidos
	public Set<Order> getOrders() { // pegando todos os Orders dentro do OrderItem
