...
public ResponseEntity<Void>delete(@PathVariable Long id){ // usei void pois como eu quero deletar então nao pode retornar nada e o pathvariable é para o id ser reconhecido como uma variavel
